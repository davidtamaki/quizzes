view: answers {
  ...
  measure: drill_common_wrong_reasons {
    ...
    hidden: yes
    sql: 1 ;;
    filters: {field: all_wrong_area_checks.all_wrong_reasons value: "-NULL"}
